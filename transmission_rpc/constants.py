...
TORRENT_ARGS = {
    'get': {
        ...
        'desiredAvailable':             ('number',   1,  None, None,                       None,                'Number of bytes available and left to be downloaded.'),
        ...
        'downloadLimitMode':            ('number',   1,  5,    None,                       None,                'Download limit mode. 0 means global, 1 means single, 2 unlimited.'),
        ...
        'fileStats':                    ('array',    5,  None, None,                       None,                'Away of file statistics containing bytesCompleted, wanted and priority.'),
        ...
        'uploadLimitMode':              ('number',   1,  5,    None,                       None,                'Upload limit mode. 0 means global, 1 means single, 2 unlimited.'),
...
SESSION_ARGS = {
    'get': {
        ...
        "alt-speed-enabled":            ('boolean',  5,  None, None,                       None,                'True if alternate global download speed limiter is enabled.'),
