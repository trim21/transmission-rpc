...
# a tree.
# set +- <argument1> - [<type>, <added version>,
#                                      <removed version>, <previous argument name>, <next argument name>, <description>]
#  |  +- <argument2> - [<type>, <added version>,
#                                      <removed version>, <previous argument name>, <next argument name>, <description>]
#  |
# get +- <argument1> - [<type>, <added version>,
#                                      <removed version>, <previous argument name>, <next argument name>, <description>]
#     +- <argument2> - [<type>, <added version>,
#                                      <removed version>, <previous argument name>, <next argument name>, <description>]
...
TORRENT_ARGS = {
    'get': {
        ...
        'downloaders':
            ('number', 4, 7, None, None, 'Number of downloaders.'),
        'downloadLimit':
            ('number', 1, None, None, None, 'Download limit in Kbps.'),
        'downloadLimited':
            ('boolean', 5, None, None, None, 'Download limit is enabled'),
        'downloadLimitMode':
            ('number', 1, 5, None, None, 'Download limit mode. 0 means global, 1 means single, 2 unlimited.'),
        'error':
            ('number', 1, None, None, None,
             'Kind of error. 0 means OK, 1 means tracker warning, 2 means tracker error, 3 means local error.'),
        'errorString':
            ('number', 1, None, None, None, 'Error message.'),
        'eta':
            ('number', 1, None, None, None,
             'Estimated number of seconds left when downloading or seeding. -1 means not available and -2 means '
             'unknown.'),
        'etaIdle':
            ('number', 15, None, None, None,
             'Estimated number of seconds left until the idle time limit is reached. -1 means not available and -2 '
             'means unknown.'),
        'files':
            ('array', 1, None, None, None, 'Array of file object containing key, bytesCompleted, length and name.'),
        'fileStats':
            ('array', 5, None, None, None, 'Array of file statistics containing bytesCompleted, wanted and priority.'),
        'hashString':
            ('string', 1, None, None, None, 'Hashstring unique for the torrent even between sessions.'),
        'haveUnchecked':
            ('number', 1, None, None, None, 'Number of bytes of partial pieces.'),
        'haveValid':
        ...
        'id':
            ('number', 1, None, None, None, 'Session unique torrent id.'),
        'isFinished':
            ('boolean', 9, None, None, None, 'True if the torrent is finished. Downloaded and seeded.'),
        'isPrivate':
            ('boolean', 1, None, None, None, 'True if the torrent is private.'),
        'isStalled':
            ('boolean', 14, None, None, None, 'True if the torrent has stalled (been idle for a long time).'),
        'lastAnnounceTime':
            ('number', 1, 7, None, None, 'The time of the last announcement.'),
        'lastScrapeTime':
            ('number', 1, 7, None, None, 'The time af the last successful scrape.'),
        'leechers':
            ('number', 1, 7, None, None, 'Number of leechers.'),
        'leftUntilDone':
            ('number', 1, None, None, None, 'Number of bytes left until the download is done.'),
        'magnetLink':
            ('string', 7, None, None, None, 'The magnet link for this torrent.'),
        'manualAnnounceTime':
            ('number', 1, None, None, None, 'The time until you manually ask for more peers.'),
        'maxConnectedPeers':
            ('number', 1, None, None, None, 'Maximum of connected peers.'),
        'metadataPercentComplete':
            ('number', 7, None, None, None, 'Download progress of metadata. 0.0 to 1.0.'),
        'name':
            ('string', 1, None, None, None, 'Torrent name.'),
        'nextAnnounceTime':
            ('number', 1, 7, None, None, 'Next announce time.'),
        'nextScrapeTime':
            ('number', 1, 7, None, None, 'Next scrape time.'),
        'peer-limit':
            ('number', 5, None, None, None, 'Maximum number of peers.'),
        'peers':
            ('array', 2, None, None, None, 'Array of peer objects.'),
        'peersConnected':
        ...
        'peersKnown':
            ('number', 1, 13, None, None, 'Number of peers that the tracker knows.'),
        'peersSendingToUs':
            ('number', 1, None, None, None, 'Number of peers sending to us'),
        'percentDone':
            ('double', 5, None, None, None, 'Download progress of selected files. 0.0 to 1.0.'),
        'pieces':
            ('string', 5, None, None, None, 'String with base64 encoded bitfield indicating finished pieces.'),
        'pieceCount':
            ('number', 1, None, None, None, 'Number of pieces.'),
        'pieceSize':
            ('number', 1, None, None, None, 'Number of bytes in a piece.'),
        'priorities':
            ('array', 1, None, None, None, 'Array of file priorities.'),
        'queuePosition':
            ('number', 14, None, None, None, 'The queue position.'),
        'rateDownload':
            ('number', 1, None, None, None, 'Download rate in bps.'),
        'rateUpload':
            ('number', 1, None, None, None, 'Upload rate in bps.'),
        'recheckProgress':
            ('double', 1, None, None, None, 'Progress of recheck. 0.0 to 1.0.'),
        'secondsDownloading':
            ('number', 15, None, None, None, ''),
        'secondsSeeding':
            ('number', 15, None, None, None, ''),
        'scrapeResponse':
            ('string', 1, 7, None, None, 'Scrape response message.'),
        'scrapeURL':
            ('string', 1, 7, None, None, 'Current scrape URL'),
        'seeders':
            ('number', 1, 7, None, None, 'Number of seeders reported by the tracker.'),
        'seedIdleLimit':
            ('number', 10, None, None, None, 'Idle limit in minutes.'),
        'seedIdleMode':
            ('number', 10, None, None, None, 'Use global (0), torrent (1), or unlimited (2) limit.'),
        'seedRatioLimit':
            ('double', 5, None, None, None, 'Seed ratio limit.'),
        'seedRatioMode':
        ...
        'totalSize':
            ('number', 1, None, None, None, 'Total size of the torrent in bytes'),
        'torrentFile':
            ('string', 5, None, None, None, 'Path to .torrent file.'),
        'uploadedEver':
            ('number', 1, None, None, None, 'Number of bytes uploaded, ever.'),
        'uploadLimit':
            ('number', 1, None, None, None, 'Upload limit in Kbps'),
        'uploadLimitMode':
            ('number', 1, 5, None, None, 'Upload limit mode. 0 means global, 1 means single, 2 unlimited.'),
        'uploadLimited':
            ('boolean', 5, None, None, None, 'Upload limit enabled.'),
        'uploadRatio':
            ('double', 1, None, None, None, 'Seed ratio.'),
        'wanted':
            ('array', 1, None, None, None, 'Array of booleans indicated wanted files.'),
        'webseeds':
    ...
    'set': {
        ...
        'downloadLimit':
            ('number', 5, None, 'speed-limit-down', None, 'Set the speed limit for download in Kib/s.'),
        'downloadLimited':
        ...
        'location':
            ('array', 1, None, None, None, 'Local download location.'),
        'peer-limit':
        ...
        'seedRatioLimit':
            ('double', 5, None, None, None, 'Seeding ratio.'),
        'seedRatioMode':
    ...
    'add': {
        ...
        'peer-limit':
            ('number', 1, None, None, None, 'Maximum number of peers allowed.'),
        'priority-high':
            ('array', 1, None, None, None, "A list of file id's that should have high priority."),
        'priority-low':
            ('array', 1, None, None, None, "A list of file id's that should have low priority."),
...
SESSION_ARGS = {
    'get': {
        ...
        "alt-speed-enabled":
            ('boolean', 5, None, None, None, 'True if alternate global download speed limiter is enabled.'),
        ...
        "blocklist-url":
            ('string', 11, None, None, None, 'Location of the block list. Updated with blocklist-update.'),
        "cache-size-mb":
        ...
        "peer-limit":
            ('number', 1, 5, None, 'peer-limit-global', 'Maximum number of peers.'),
        "peer-limit-global":
        ...
        "port":
            ('number', 1, 5, None, 'peer-port', 'Peer port.'),
        "peer-port":
            ('number', 5, None, 'port', None, 'Peer port.'),
        ...
        "seedRatioLimit":
            ('double', 5, None, None, None, 'Seed ratio limit. 1.0 means 1:1 download and upload ratio.'),
        "seedRatioLimited":
        ...
        "version":
            ('string', 3, None, None, None, 'Transmission version.'),
    },
    'set': {
        "alt-speed-down":
            ('number', 5, None, None, None, 'Alternate session download speed limit (in Kib/s).'),
        ...
        "cache-size-mb":
            ('number', 10, None, None, None, 'The maximum size of the disk cache in MB'),
        "dht-enabled":
            ('boolean', 6, None, None, None, 'Enables DHT.'),
        "download-dir":
        ...
        "incomplete-dir-enabled":
            ('boolean', 7, None, None, None,
             'Enables the incomplete transfer data directory. Otherwise data for incomplete transfers are stored in '
             'the download target.'),
        "lpd-enabled":
