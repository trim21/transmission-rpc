...
TORRENT_ARGS = {
    'get': {
        ...
        'downloadLimited': (
            'boolean', 5, None, 'speed-limit-down-enabled', None,
        ...
        'speed-limit-down': (
            'number', 1, 5, None, 'downloadLimit',
            'Set the speed limit for download in Kib/s.'
        ),
        'speed-limit-down-enabled': (
            'boolean', 1, 5, None, 'downloadLimited',
            'Enable download speed limiter.'
        ),
        'speed-limit-up': (
            'number', 1, 5, None, 'uploadLimit',
            'Set the speed limit for upload in Kib/s.'
        ),
        'speed-limit-up-enabled': (
            'boolean', 1, 5, None, 'uploadLimited',
        ...
        'uploadLimit': (
            'number', 5, None, 'speed-limit-up', None,
            'Set the speed limit for upload in Kib/s.'
        ),
        'uploadLimited': (
            'boolean', 5, None, 'speed-limit-up-enabled', None,
            'Enable upload speed limiter.'
        ),
    }, 'add': {
        'bandwidthPriority': (
